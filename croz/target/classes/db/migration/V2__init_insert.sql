insert into category(id, name) values(1, 'glupi');
insert into category(id, name) values(2, 'doktori');
insert into category(id, name) values(3, 'policajci');

insert into joke(id, content) values(1, 'Guraju se dvije plavuše na krevetu i jedna padne. Ova druga je zbunjeno odmah pozove: Daj dođi gore, sad ima puno više mjesta.');
